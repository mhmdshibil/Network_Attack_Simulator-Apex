    ...
    <div>
      ...
      <div className="table-container">
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '16px', padding: '8px 16px 8px 20px', borderBottom: `1px solid ${T.border}` }}>
          ...
          <div style={{ minWidth: '140px', fontFamily: "'IBM Plex Sans',sans-serif", fontSize: '10px', fontWeight: 600, color: T.muted, textTransform: 'uppercase', letterSpacing: '0.1em' }}>Threat Score</div>
          <div style={{ minWidth: '80px',  fontFamily: "'IBM Plex Sans',sans-serif", fontSize: '10px', fontWeight: 600, color: T.muted, textTransform: 'uppercase', letterSpacing: '0.1em' }}>Level</div>
                ...
                <div key={i} className="expandable-row-wrapper">
                  ...
                  >
                    <div style={{ display: 'flex', alignItems: 'center', gap: '16px', padding: '10px 16px 10px 18px' }}>
                      ...
                      <div style={{ marginLeft: 'auto', fontFamily: "'IBM Plex Mono',monospace", fontSize: '11px', color: T.muted }}>{risk.attack_count}</div>
                    </div>
                  </div>
                    ...
                    <div className="expanded-details">
                      <div style={{ display: 'flex', flexWrap: 'wrap' }}>
                        {[
                          ...
                          { label: 'Threat Score', value: `${risk.risk_score.toFixed(1)} / 100` },
                        ].map((d, j) => (
