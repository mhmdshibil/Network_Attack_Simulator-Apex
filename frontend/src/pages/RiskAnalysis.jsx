...
/* Severity → monochrome visual weights */
    ...
    <div>
      ...
      <div className="table-container">
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '16px', padding: '9px 16px 9px 20px', borderBottom: `1px solid ${T.border}` }}>
          ...
          {['IP Address', 'Risk Score', 'Severity', 'Confidence', 'Events'].map((h, i) => (
                    ...
                    <div className="expanded-details">
                      <div style={{ display: 'flex', flexWrap: 'wrap' }}>
                        {[
                          ...
                          { label: 'Risk Score',   value: `${risk.risk_score.toFixed(1)} / 100`, bold: risk.risk_score >= 70 },
                        ].map((d, j) => (
