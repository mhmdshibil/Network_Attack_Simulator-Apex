...
ORG_NAME = os.getenv("ORG_NAME", "Rajagiri School of Engineering and Technology")
...
def compliance_report(_: dict = Depends(require_analyst)):
    ...
    story += [
        ...
        Spacer(1, 14 * mm),
        Paragraph("Generated by Apex-Kinetics SOC Platform v2.0", foot),
    ]
    ...
    doc = SimpleDocTemplate(
        ...
        title="Apex-Kinetics Compliance Report",
    )
    doc.build(story)
